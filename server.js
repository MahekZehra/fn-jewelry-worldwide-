  ...
  async (req, res) => {
    try {
      ...
      /* ===================================================
         ...
         IMPORTANT:
         Checkout sends converted price as item.price.

         Example:

         PKR → item.price = converted PKR price
         USD → item.price = converted USD price
         EUR → item.price = converted EUR price
